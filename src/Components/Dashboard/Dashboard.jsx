    ...
    <div id='dashboard-container'>
      ...
      <div className="dashboard__menu">
        <ul className='dashboard__ul'>
          <li>Dashboard</li>
          <li className='dashboard__li more'>LiT Recruit <img className='dashboard__more-icon' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxko8FEz44oDExWQqtw1uFD4SADsL7sNxsLA&usqp=CAU" alt="more-icon" /></li>
